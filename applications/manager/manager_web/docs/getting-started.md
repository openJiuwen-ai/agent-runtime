...
新建 Agent模板，用于配置用户可对话的 Agent。

![新建Agent模板](assets/image-20260912155054886.png)

### 新建 运行时模板

新建 运行时模板，用于为组织或用户分配可用的容器资源池。可以直接导入版本部署工具中提供的 agentserver.json 文件。

![新建运行时模板](assets/image-20260912155116428.png)
...
配置集群上可用的运行时及其授权范围。授权范围支持全员可用、特定组织可用、特定用户可用或特定 Agent 可用，本文以授权给组织为例。

![集群运行时配置](assets/image-20260912155310664.png)
