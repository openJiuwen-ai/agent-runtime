    ...
    *,
    ...
    await handler.create(
        INSTANCE_INFO_TABLE_DEF.table_name,
        {
            ...
            "description": None,
            "namespace": "default",
            "gateway_host": "http://127.0.0.1:18080",
            "gateway_status": "online",
            "runtime_host": "http://127.0.0.1:18081",
...
async def test_bootstrap_seed_once_sets_log_masking_seeded_flag(
    ...
    with patch(
        "manager_server.core.application_config.log_masking_rule.seed_builtin_log_masking_rules",
