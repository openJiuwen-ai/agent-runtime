...
from manager_server.security.field_crypto import (
    DEK_ALG,
    ENC_SCHEME,
    ENC_VERSION,
...
from manager_server.security.crypto_primitives import b64e as _b64
from manager_server.security.frame_signer import attach_signature
from manager_server.security.sign_provider import (
    get_config_signature_provider,
    get_manager_signing_key,
)
from manager_server.security.keys import (
...
from manager_server.manager_ws_server.handshake_auth import check_handshake
from manager_server.manager_ws_server.protocol import (
...
from manager_server.manager_ws_server.pod_status_cache import (
...
class ManagerWsServer:
    ...
    async def _handle_register(self, ws: Any, key: int, data: dict[str, Any]) -> None:
        ...
        asyncio.create_task(
            self._run_on_gateway_register(get_db_handler(), jiuwenclaw_id),
