"""安全护栏模板 permissions_template 业务逻辑。"""
...
from manager_server.models.template_models import PERMISSIONS_TEMPLATE_TABLE_DEF
...
class PermissionsTemplateService:
    ...
    def _build_row_for_create(
        body: PermissionsTemplateCreateBody, *, template_id: str
    ) -> dict[str, Any]:
        return {
    ...
    async def get(self, template_id: str) -> PermissionsTemplateOut | None:
    ...
    async def list_templates(
        self,
        query: PermissionsTemplateListQuery,
    ) -> dict[str, Any]:
    ...
    async def delete(self, template_id: str) -> bool:
        ...
        await assert_template_deletable(
            self._handler, template_id, "permissions_templates"
        )
