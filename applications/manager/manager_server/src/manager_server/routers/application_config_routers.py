...
from manager_server.core.application_config.channel_config import (
    ChannelConfigService,
    ChannelRegisterParams,
)
from manager_server.core.application_config.embed_config import EmbedConfigService
...
from manager_server.core.application_config.permissions_config import PermissionsConfigService
